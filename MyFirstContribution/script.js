...
function addElement(userData) {
  ...
  if (userData.profilePic) childTag1_img.src = userData.profilePic;
  ...
  const occupation = document.createTextNode(
  ...
  li = document.createElement("li");
  const favouriteQuote = document.createTextNode(
    "Favourite Quote: " + userData.favouriteQuote
  );
